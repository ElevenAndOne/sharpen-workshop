...
## Copy rules
No emojis. Numbers over adjectives. Pending content is shown as pending (refund policy, event video) — never filled in. Neither video in the client outline is Chef Deb's; until the real reel arrives the video block links to instagram.com/chefdebcoaching. Social links are the ones in chefdeb.com's own header. Internal discount codes never appear in the build; only EARLYBIRD and BAC are public.
